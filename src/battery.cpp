...
static const uint8_t battery_IMG_USB[] = {

    0x80, 0xff, 0x03, 0xfe, 0xff, 0x07, 0xff, 0x00, 0x3e, 0xc3, 0x82, 0x3e, 0xc3, 0x82, 0x06, 0xc3,
    0xc6, 0x06, 0xc3, 0x7c, 0x3e, 0xff, 0x00, 0x3e, 0xfe, 0xff, 0x07, 0x80, 0xff, 0x03};
...
{
    return battery_IMG_USB;
}


const uint16_t getBatteryNum()
{
    int16_t batteryNum = ((hal.VCC - 3300) * 100) / 900;
    if (batteryNum > 100)
    {
        batteryNum = 100;
    }
